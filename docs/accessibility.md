...
- **A tooltip trigger carries `gwo-tip`.** `shared/tooltips.js` then lets
  ...
  trigger. `shared/tooltips.css` gives the tooltip a line height of 1.5 (1.4.8),
  and gives an `info_tip` "?" a 24px target (2.5.8).
...
| 1.4.13 | AA    | Fixed  | GWO tooltips stay open while hovered, and Escape dismisses them. `shared/tooltips.js`.                                                                                                                                                                    |
