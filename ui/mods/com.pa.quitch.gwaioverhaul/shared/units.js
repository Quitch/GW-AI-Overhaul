...
define({
  ...
  airFactory: "/pa/units/air/air_factory/air_factory.json",
  airFactoryAdvanced: "/pa/units/air/air_factory_adv/air_factory_adv.json",
  airFactoryAdvancedBuildArm:
    "/pa/units/air/air_factory_adv/air_factory_adv_build_arm.json",
  airFactoryBuildArm: "/pa/units/air/air_factory/air_factory_build_arm.json",
  anchor: "/pa/units/orbital/defense_satellite/defense_satellite.json",
  anchorAmmoAG:
  ...
  angelAmmo:
    "/pa/units/air/support_platform/support_platform_interception_ammo.json",
  angelBeam:
  ...
  antAmmo: "/pa/units/land/tank_light_laser/tank_light_laser_ammo.json",
  antiNukeLauncher: "/pa/units/land/anti_nuke_launcher/anti_nuke_launcher.json",
  ...
  ares: "/pa/units/land/titan_vehicle/titan_vehicle.json",
  aresAmmo: "/pa/units/land/titan_vehicle/titan_vehicle_ammo_main.json",
  aresDeath: "/pa/units/land/titan_vehicle/titan_vehicle_ammo_death.json",
  aresSecondary:
  ...
  aresStompAmmo: "/pa/units/land/titan_vehicle/titan_vehicle_ammo_stomp.json",
  aresWeapon:
  ...
  artemisAmmo: "/pa/units/orbital/orbital_railgun/orbital_railgun_ammo.json",
  artemisWeapon:
  ...
  atlas: "/pa/units/land/titan_bot/titan_bot.json",
  atlasAmmo: "/pa/units/land/titan_bot/titan_bot_ammo_stomp.json",
  atlasDeath: "/pa/units/land/titan_bot/titan_bot_ammo_death.json",
  atlasWeapon: "/pa/units/land/titan_bot/titan_bot_tool_weapon_stomp.json",
  avenger: "/pa/units/orbital/orbital_fighter/orbital_fighter.json",
  avengerAmmo: "/pa/units/orbital/orbital_fighter/orbital_fighter_ammo.json",
  avengerWeapon:
    "/pa/units/orbital/orbital_fighter/orbital_fighter_tool_weapon.json",
  ...
  botFabber: "/pa/units/land/fabrication_bot/fabrication_bot.json",
  botFabberAdvanced:
  ...
  botFactory: "/pa/units/land/bot_factory/bot_factory.json",
  botFactoryAdvanced: "/pa/units/land/bot_factory_adv/bot_factory_adv.json",
  botFactoryAdvancedBuildArm:
    "/pa/units/land/bot_factory_adv/bot_factory_adv_build_arm.json",
  botFactoryBuildArm: "/pa/units/land/bot_factory/bot_factory_build_arm.json",
  bumblebee: "/pa/units/air/bomber/bomber.json",
  bumblebeeAmmo: "/pa/units/air/bomber/bomber_ammo.json",
  bumblebeeWeapon: "/pa/units/air/bomber/bomber_tool_weapon.json",
  catalyst: "/pa/units/land/control_module/control_module.json",
  catapult:
  ...
  doxAmmo: "/pa/units/land/assault_bot/assault_bot_ammo.json",
  doxWeapon: "/pa/units/land/assault_bot/assault_bot_tool_weapon.json",
  drifter: "/pa/units/land/tank_hover/tank_hover.json",
  drifterAmmo: "/pa/units/land/tank_hover/tank_hover_ammo.json",
  drifterWeapon: "/pa/units/land/tank_hover/tank_hover_tool_weapon.json",
  energyPlant: "/pa/units/land/energy_plant/energy_plant.json",
  ...
  galata: "/pa/units/land/air_defense/air_defense.json",
  galataAmmo: "/pa/units/land/air_defense/air_defense_ammo.json",
  ...
  holkinsAmmo: "/pa/units/land/artillery_long/artillery_long_ammo.json",
  holkinsWeapon:
    "/pa/units/land/artillery_long/artillery_long_tool_weapon.json",
  hornet: "/pa/units/air/bomber_adv/bomber_adv.json",
  hornetAmmo: "/pa/units/air/bomber_adv/bomber_adv_ammo.json",
  hornetWeapon: "/pa/units/air/bomber_adv/bomber_adv_tool_weapon.json",
  horsefly: "/pa/units/air/strafer/strafer.json",
  horseflyAmmo: "/pa/units/air/strafer/strafer_ammo.json",
  horseflyWeapon: "/pa/units/air/strafer/strafer_tool_weapon.json",
  hummingbird: "/pa/units/air/fighter/fighter.json",
  hummingbirdAmmo: "/pa/units/air/fighter/fighter_ammo.json",
  hummingbirdWeapon: "/pa/units/air/fighter/fighter_tool_weapon.json",
  icarus: "/pa/units/air/solar_drone/solar_drone.json",
  icarusAmmo: "/pa/units/air/solar_drone/solar_drone_ammo.json",
  icarusWeapon: "/pa/units/air/solar_drone/solar_drone_tool_weapon.json",
  inferno: "/pa/units/land/tank_armor/tank_armor.json",
  infernoAmmo: "/pa/units/land/tank_armor/tank_armor_ammo.json",
  infernoWeapon: "/pa/units/land/tank_armor/tank_armor_tool_weapon.json",
  jig: "/pa/units/orbital/mining_platform/mining_platform.json",
  jigDeath: "/pa/units/orbital/mining_platform/mining_platform_nuke.json",
  kaiju: "/pa/units/sea/hover_ship/hover_ship.json",
  kaijuAmmo: "/pa/units/sea/hover_ship/hover_ship_ammo.json",
  ...
  krakenMissileAmmo: "/pa/units/sea/nuclear_sub/nuclear_sub_ammo_missile.json",
  krakenWeapon: "/pa/units/sea/nuclear_sub/nuclear_sub_tool_weapon.json",
  krakenWeaponAmmo: "/pa/units/sea/nuclear_sub/nuclear_sub_ammo.json",
  landMine: "/pa/units/land/land_mine/land_mine.json",
  landMineAmmo: "/pa/units/land/land_mine/land_mine_ammo.json",
  landMineWeapon: "/pa/units/land/land_mine/land_mine_tool_weapon.json",
  laserDefenseTower: "/pa/units/land/laser_defense/laser_defense.json",
  ...
  laserDefenseTowerAmmo: "/pa/units/land/laser_defense/laser_defense_ammo.json",
  ...
  levelerAmmo: "/pa/units/land/tank_laser_adv/tank_laser_adv_ammo.json",
  levelerWeapon:
    "/pa/units/land/tank_laser_adv/tank_laser_adv_tool_weapon.json",
  leviathan: "/pa/units/sea/battleship/battleship.json",
  leviathanAmmo: "/pa/units/sea/battleship/battleship_ammo.json",
  leviathanWeapon: "/pa/units/sea/battleship/battleship_tool_weapon.json",
  lob: "/pa/units/land/artillery_unit_launcher/artillery_unit_launcher.json",
  lobAmmo:
  ...
  locusts: "/pa/units/land/bot_nanoswarm/bot_nanoswarm.json",
  locustsAmmo: "/pa/units/land/bot_nanoswarm/bot_nanoswarm_ammo.json",
  locustsBuildArm: "/pa/units/land/bot_nanoswarm/bot_nanoswarm_build_arm.json",
  locustsWeapon: "/pa/units/land/bot_nanoswarm/bot_nanoswarm_tool_weapon.json",
  manhattan: "/pa/units/land/tank_nuke/tank_nuke.json",
  manhattanDeath: "/pa/units/land/tank_nuke/tank_nuke_pbaoe.json",
  manhattanWeapon: "/pa/units/land/tank_nuke/tank_nuke_tool_weapon.json",
  ...
  metalExtractor: "/pa/units/land/metal_extractor/metal_extractor.json",
  metalExtractorAdvanced:
    "/pa/units/land/metal_extractor_adv/metal_extractor_adv.json",
  metalStorage: "/pa/units/land/metal_storage/metal_storage.json",
  narwhal: "/pa/units/sea/frigate/frigate.json",
  narwhalAA: "/pa/units/sea/frigate/frigate_tool_weapon_aa.json",
  narwhalAAAmmo: "/pa/units/sea/frigate/frigate_ammo_aa.json",
  narwhalAmmo: "/pa/units/sea/frigate/frigate_ammo_shell.json",
  narwhalTorpedo: "/pa/units/sea/frigate/frigate_tool_weapon_torpedo.json",
  narwhalTorpedoAmmo: "/pa/units/sea/frigate/frigate_ammo_torpedo.json",
  narwhalWeapon: "/pa/units/sea/frigate/frigate_tool_weapon_shell.json",
  navalFabber: "/pa/units/sea/fabrication_ship/fabrication_ship.json",
  navalFabberAdvanced:
  ...
  navalFactory: "/pa/units/sea/naval_factory/naval_factory.json",
  ...
  nukeLauncher: "/pa/units/land/nuke_launcher/nuke_launcher.json",
  nukeLauncherAmmo: "/pa/units/land/nuke_launcher/nuke_launcher_ammo.json",
  ...
  orbitalFactory: "/pa/units/orbital/orbital_factory/orbital_factory.json",
  orbitalFactoryBuildArm:
    "/pa/units/orbital/orbital_factory/orbital_factory_build_arm.json",
  orbitalLauncher: "/pa/units/orbital/orbital_launcher/orbital_launcher.json",
  ...
  pelterAmmo: "/pa/units/land/artillery_short/artillery_short_ammo.json",
  pelterWeapon:
    "/pa/units/land/artillery_short/artillery_short_tool_weapon.json",
  phoenix: "/pa/units/air/fighter_adv/fighter_adv.json",
  phoenixAmmo: "/pa/units/air/fighter_adv/fighter_adv_ammo.json",
  phoenixWeapon: "/pa/units/air/fighter_adv/fighter_adv_tool_weapon.json",
  piranha: "/pa/units/sea/sea_scout/sea_scout.json",
  piranhaAmmo: "/pa/units/sea/sea_scout/sea_scout_ammo.json",
  ...
  ragnarokPbaoe: "/pa/units/land/titan_structure/titan_structure_pbaoe.json",
  ragnarokWeapon:
  ...
  shellerAmmo: "/pa/units/land/tank_heavy_mortar/tank_heavy_mortar_ammo.json",
  shellerWeapon:
    "/pa/units/land/tank_heavy_mortar/tank_heavy_mortar_tool_weapon.json",
  ...
  sparkAmmo: "/pa/units/land/bot_tesla/bot_tesla_ammo.json",
  sparkWeapon: "/pa/units/land/bot_tesla/bot_tesla_tool_weapon.json",
  spinner: "/pa/units/land/aa_missile_vehicle/aa_missile_vehicle.json",
  spinnerAmmo: "/pa/units/land/aa_missile_vehicle/aa_missile_vehicle_ammo.json",
  spinnerWeapon:
    "/pa/units/land/aa_missile_vehicle/aa_missile_vehicle_tool_weapon.json",
  squall: "/pa/units/sea/drone_carrier/drone/drone.json",
  squallAmmo: "/pa/units/sea/drone_carrier/drone/drone_ammo.json",
  squallTorpedo: "/pa/units/sea/drone_carrier/drone/drone_tool_torpedo.json",
  squallTorpedoAmmo:
    "/pa/units/sea/drone_carrier/drone/drone_ammo_torpedo.json",
  squallWeapon: "/pa/units/sea/drone_carrier/drone/drone_tool_weapon.json",
  stinger: "/pa/units/land/bot_aa/bot_aa.json",
  stingerAmmo: "/pa/units/land/bot_aa/bot_aa_ammo.json",
  stingerWeapon: "/pa/units/land/bot_aa/bot_aa_tool_weapon.json",
  stingray: "/pa/units/sea/missile_ship/missile_ship.json",
  stingrayAA: "/pa/units/sea/missile_ship/missile_ship_aa_tool_weapon.json",
  stingrayAAAmmo: "/pa/units/sea/missile_ship/missile_ship_aa_ammo.json",
  stingrayAmmo: "/pa/units/sea/missile_ship/missile_ship_ammo.json",
  stingrayBeam: "/pa/units/sea/missile_ship/missile_ship_tool_antidrop.json",
  stingrayBeamAmmo:
    "/pa/units/sea/missile_ship/missile_ship_antidrop_ammo.json",
  stingrayWeapon: "/pa/units/sea/missile_ship/missile_ship_tool_weapon.json",
  ...
  stormAmmo: "/pa/units/land/tank_flak/tank_flak_ammo.json",
  stormWeapon: "/pa/units/land/tank_flak/tank_flak_tool_weapon.json",
  stryker: "/pa/units/land/attack_vehicle/attack_vehicle.json",
  strykerAmmo: "/pa/units/land/attack_vehicle/attack_vehicle_ammo.json",
  strykerWeapon:
    "/pa/units/land/attack_vehicle/attack_vehicle_tool_weapon.json",
  sxx: "/pa/units/orbital/orbital_laser/orbital_laser.json",
  sxxAmmo: "/pa/units/orbital/orbital_laser/orbital_laser_ammo.json",
  sxxWeapon: "/pa/units/orbital/orbital_laser/orbital_laser_tool_weapon.json",
  teleporter: "/pa/units/land/teleporter/teleporter.json",
  ...
  typhoonAmmo: "/pa/units/sea/drone_carrier/carrier/carrier_ammo.json",
  typhoonWeapon: "/pa/units/sea/drone_carrier/carrier/carrier_tool_weapon.json",
  umbrella: "/pa/units/orbital/ion_defense/ion_defense.json",
  umbrellaAmmo: "/pa/units/orbital/ion_defense/ion_defense_ammo.json",
  umbrellaBeam: "/pa/units/orbital/ion_defense/ion_defense_tool_antidrop.json",
  umbrellaBeamAmmo:
    "/pa/units/orbital/ion_defense/ion_defense_antidrop_ammo.json",
  umbrellaWeapon: "/pa/units/orbital/ion_defense/ion_defense_tool_weapon.json",
  unitCannon: "/pa/units/land/unit_cannon/unit_cannon.json",
  unitCannonBuildArm: "/pa/units/land/unit_cannon/unit_cannon_build_arm.json",
  unitCannonWeapon: "/pa/units/land/unit_cannon/unit_cannon_tool_weapon.json",
  vanguard: "/pa/units/land/tank_heavy_armor/tank_heavy_armor.json",
  vanguardAmmo: "/pa/units/land/tank_heavy_armor/tank_heavy_armor_ammo.json",
  vanguardWeapon:
    "/pa/units/land/tank_heavy_armor/tank_heavy_armor_tool_weapon.json",
  vehicleFabber: "/pa/units/land/fabrication_vehicle/fabrication_vehicle.json",
  ...
  vehicleFactory: "/pa/units/land/vehicle_factory/vehicle_factory.json",
  ...
  wyrmWeapon: "/pa/units/air/bomber_heavy/bomber_heavy_tool_weapon.json",
  zeus: "/pa/units/air/titan_air/titan_air.json",
