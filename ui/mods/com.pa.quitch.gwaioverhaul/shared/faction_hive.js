  ...
  return {
    ...
    teams: [
      ...
      },
      {
        ...
        systemDescription:
          "!LOC:The Hive are unique in that their motivations are individual rather than collective. Each Seeker follows in the example of their legendary Osiris--they seek battle to become stronger through their fallen enemies, and to create more Hive.",
        systemTemplate: {
          name: "Epiphany - Hive",
          Planets: [
            {
      ...
      },
      {
        ...
        systemDescription:
          "!LOC:Osiris holds no interest in ruling, and instead serves more as an exemplar, whether he cares to or not. Therefore, it falls to a small council of older Seekers to direct the affairs of The Hive at large--primarily making sure that they're fighting the other factions instead of amongst themselves.",
        systemTemplate: {
          name: "Varthema - Hive",
          Planets: [
            {
