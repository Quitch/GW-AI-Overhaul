// We want to write our start cards to a different localStorageKey so that if
// the mod is uninstalled the gw_start card list isn't messed up by 404 unlocks
define([], function () {
