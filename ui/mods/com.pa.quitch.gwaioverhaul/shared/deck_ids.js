// The built-in tech card ids, in one place. Array order feeds the seeded deal
// (setupGwoDeck indexes by position), so it is load-bearing. See galaxy.md.
define(function () {
  var basic = [
    "gwc_add_card_slot",
  ...
  return { basic: basic, expanded: expanded };
});
