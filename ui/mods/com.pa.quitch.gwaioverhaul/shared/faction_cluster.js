    ...
    teams: [
      {
        ...
        systemDescription:
          "!LOC:We do not understand the divisions that have torn us asunder. Once we were as one, marching in lockstep, with one mind, one purpose. What cruelty the Progenitors wrought to reduce us to this.",
        systemTemplate: {
          name: "Bang Battle - Cluster",
          Planets: [
            {
