...
define(() => ({
  ...
  units: {
    ...
    bigBoomerEggAmmo: "/pa/units/structure/bug_mine_big/bug_mine_big_ammo.json",
    bigBoomerEggWeapon:
    ...
    boomerEggAltWeapon: "/pa/units/structure/bug_mine/bug_mine_alt_weapon.json",
    ...
    holkinsAmmo: "/pa/units/structure/bug_arty_large/bug_arty_large_ammo.json",
    holkinsWeapon:
    ...
    laserPlatform: "/pa/units/orbital/bug_orbital_laser/bug_orbital_laser.json",
    laserPlatformAmmo:
    ...
    navalFactory: "/pa/units/structure/basic_naval_hive/basic_naval_hive.json",
    ...
    phoenixWeapon: "/pa/units/air/bug_fighter_adv/bug_fighter_adv_weapon.json",
    ...
    spire: "/pa/units/structure/bug_orbital_launcher/bug_orbital_launcher.json",
    stealthRipper: "/pa/units/land/bug_ripper_stealth/bug_ripper_stealth.json",
    stealthRipperAmmo:
