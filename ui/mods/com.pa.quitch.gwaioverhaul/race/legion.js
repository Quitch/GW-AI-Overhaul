...
// shared/units.js, so Legion-only cards can address them) and `unitNames`
// carries the display names by Legion key. What a Legion player fields for the
// vanilla units held follows from capability cells, not from a table. See
// races.md.
define(() => ({
  id: "legion",
  name: "!LOC:Legion",
  ...
  units: {
    ...
    archerAmmo: "/pa/units/land/l_air_defense_adv/l_air_defense_adv_ammo.json",
    archerWeapon:
    ...
    centurion: "/pa/units/orbital/l_defense_satellite/l_defense_satellite.json",
    centurionAmmo:
    ...
    corsairWeapon: "/pa/units/land/l_hover_tank/l_hover_tank_tool_weapon.json",
    ...
    decimatorAmmo: "/pa/units/land/l_rocket_barrage/l_rocket_barrage_ammo.json",
    decimatorWeapon:
    ...
    holocenePbaoe: "/pa/units/land/titan_structure/titan_structure_pbaoe.json",
    holoceneWeapon:
    ...
    infiltratorAmmo: "/pa/units/air/l_air_scout_adv/l_air_scout_adv_ammo.json",
    ...
    investigatorRadar: "/pa/units/land/l_scout_bot/l_scout_bot_radar_mode.json",
    ...
    jackalAmmo: "/pa/units/land/l_t1_turret_basic/l_t1_turret_basic_ammo.json",
    jackalWeapon:
    ...
    mantaBeamAmmo: "/pa/units/sea/l_missile_ship/l_missile_ship_beam_ammo.json",
    mantaBeamWeapon:
    ...
    maulWeapon: "/pa/units/land/l_shotgun_tank/l_shotgun_tank_tool_weapon.json",
    meteor: "/pa/units/air/l_air_carrier/l_air_carrier.json",
    meteorAmmo: "/pa/units/air/l_air_carrier/l_air_carrier_ammo.json",
    meteorWeapon: "/pa/units/air/l_air_carrier/l_air_carrier_tool_weapon.json",
    ...
    scorpionAmmo: "/pa/units/land/l_tank_laser_adv/l_tank_laser_adv_ammo.json",
    scorpionWeapon:
    ...
    stokeWeapon: "/pa/units/land/l_mortar_tank/l_mortar_tank_tool_weapon.json",
    ...
    theodorAmmo: "/pa/units/land/l_artillery_short/l_artillery_short_ammo.json",
    theodorWeapon:
    ...
    tsunami: "/pa/units/sea/l_torpedo_launcher_adv/l_torpedo_launcher_adv.json",
    tsunamiWaveAmmo:
  ...
  unitNames: {
    ...
    investigatorRadarCollisionCheck: "!LOC:Investigator Radar Collision Check",
