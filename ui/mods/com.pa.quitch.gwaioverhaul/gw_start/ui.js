...
function gwoUI() {
  ...
  try {
    ...
    model.gwoWarModeTooltip =
      "!LOC:GALACTIC WAR: every system is enemy-held from the start. Defeat all bosses to win.<br>GALACTIC CONQUEST: each enemy faction expands from a single system. Defeat all bosses to win, but losing to one loses you the game.";
