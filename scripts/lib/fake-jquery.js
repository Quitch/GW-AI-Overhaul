...
// Covers exactly the $/api subset the shipped co-op code and the
// deliberately-still-jQuery deal/cards subsystem use (see cef-migration.md) -
// not a general polyfill. Native fetching is faked by fake-fetch.js.
